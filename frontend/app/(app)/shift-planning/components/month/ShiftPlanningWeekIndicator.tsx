...
export default function ShiftPlanningWeekIndicator({
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-4 text-left text-gray-900 shadow-sm transition-colors dark:border-gray-800 dark:bg-gray-900 dark:text-gray-100">
      <div>
