  ...
  return (
    <div className="rounded-2xl border border-dashed border-gray-300 bg-gray-50 p-4 text-sm text-gray-600 dark:border-gray-700 dark:bg-gray-950 dark:text-gray-300">
      ...
      <button
        type="button"
        onClick={onToggle}
        className="mt-3 rounded-xl border border-gray-300 px-4 py-2 font-semibold text-gray-700 hover:bg-white dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-900"
      >
