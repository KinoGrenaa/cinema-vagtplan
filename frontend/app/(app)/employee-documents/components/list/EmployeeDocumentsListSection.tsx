...
export default function EmployeeDocumentsListSection({
  ...
  const [
    ...
    useState<EmployeeDocumentTypeFilter>(
      "ALL",
    );
  const [sort, setSort] =
    useState<EmployeeDocumentSort>(
      "NEWEST",
    );
    ...
    return (
      <section className="rounded-2xl border border-dashed border-gray-300 bg-white p-8 text-center shadow-sm dark:border-gray-700 dark:bg-gray-900">
        ...
        <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
          Når en medarbejder er valgt, vises
          dokumentarkivet og
          uploadfunktionen for personen.
        </p>
      </section>
    );
  }
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
          ...
          <div className="flex flex-wrap gap-2 text-xs font-semibold">
            <span className="rounded-full border border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-700 dark:bg-gray-950">
              {summary.total} i alt
            </span>
            ...
            {visibleDocuments.map(
              (document) => {
                ...
                return (
                  <article
                    key={document.id}
                    className="rounded-2xl border border-gray-200 bg-gray-50 p-4 transition hover:border-gray-300 hover:bg-white dark:border-gray-800 dark:bg-gray-950/50 dark:hover:border-gray-700 dark:hover:bg-gray-950"
                  >
                    <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                      ...
                      <div className="flex flex-wrap gap-2 xl:justify-end">
                        ...
                        <a
                          ...
                          className="rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm font-semibold text-gray-800 transition hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 dark:hover:bg-gray-800"
                        >
                          Download
                        </a>
                        <button
