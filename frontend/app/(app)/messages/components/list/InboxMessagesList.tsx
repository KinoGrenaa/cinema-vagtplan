        ...
        (message) => {
          ...
          return (
            <article
              ...
              className={`overflow-hidden rounded-2xl border shadow-sm outline-none transition ${
                isFocused
                  ? "border-blue-500 ring-4 ring-blue-500/60 ring-offset-4 ring-offset-slate-50 dark:border-blue-400 dark:ring-blue-400/60 dark:ring-offset-[#030712]"
                  : message.isRead
