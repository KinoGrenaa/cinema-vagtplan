        ...
        return (
          ...
          >
            <button
              ...
              className="flex w-full flex-col gap-3 bg-gray-50 p-5 text-left transition hover:bg-gray-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-blue-600 dark:bg-gray-950/50 dark:hover:bg-gray-800/70 dark:focus-visible:ring-blue-400 md:flex-row md:items-center md:justify-between"
            >
              <div>
