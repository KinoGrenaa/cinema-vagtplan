          ...
          (shift) => {
            ...
            return (
              <article
                ...
                className={`rounded-xl border bg-gray-50 p-4 outline-none transition-colors dark:bg-gray-950/55 ${
                  isFocused
              ...
              >
                <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                  <div>
                    {isFocused && (
                      <span className="mb-3 inline-flex rounded-full bg-blue-700 px-3 py-1 text-xs font-semibold text-white dark:bg-blue-500">
