  ...
  return (
    <main className="p-6 max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-600">Oversigt over dine vagter pr. måned</p>
      </div>
      ...
      <section className="bg-white border rounded-xl p-4 shadow-sm">
        ...
        <p>{totalHours.toFixed(2)} timer</p>
      </section>
      ...
      <section className="space-y-4">
          ...
          return (
            ...
            >
              <div>
                ...
                <p>{shift.workType.name}</p>

                {shift.note && <p className="text-sm">Note: {shift.note}</p>}
        ...
        {myMonthShifts.length === 0 && <p>Ingen vagter i denne måned.</p>}
      </section>
    </main>
  );
}