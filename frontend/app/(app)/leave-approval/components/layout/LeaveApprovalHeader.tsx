        ...
        <div className="flex flex-wrap gap-2">
          {pendingCount > 0 && (
            <button
              ...
              className={`inline-flex items-center justify-center rounded-xl bg-orange-700 px-4 py-2 font-semibold text-white transition hover:bg-orange-800 focus-visible:ring-orange-600 dark:bg-orange-600 dark:hover:bg-orange-500 dark:focus-visible:ring-orange-400 ${focusClass}`}
            >
              Vis afventende
            </button>
          )}
          ...
          {hasCustomFilters && (
            <button
              ...
              className={`inline-flex items-center justify-center gap-2 rounded-xl border border-gray-300 bg-white px-4 py-2 font-semibold text-gray-800 transition hover:bg-gray-100 focus-visible:ring-gray-500 dark:border-gray-700 dark:bg-gray-950 dark:text-gray-100 dark:hover:bg-gray-800 dark:focus-visible:ring-gray-400 ${focusClass}`}
            >
              <RotateCcw size={18} />
              Nulstil filter
            </button>
