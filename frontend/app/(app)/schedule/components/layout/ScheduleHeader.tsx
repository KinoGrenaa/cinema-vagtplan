...
const secondaryButtonClass =
  "rounded-xl border border-gray-300 bg-white px-4 py-2 text-sm font-semibold text-gray-900 shadow-sm transition hover:bg-gray-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-500 focus-visible:ring-offset-2 dark:border-gray-700 dark:bg-gray-950 dark:text-gray-100 dark:hover:bg-gray-800 dark:focus-visible:ring-gray-400 dark:focus-visible:ring-offset-gray-900";
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          {aiGenerateDaySchedule && (
            <div className="mt-4 flex flex-wrap gap-3">
              <button
                ...
                className="rounded-2xl bg-cyan-700 px-5 py-3 font-semibold text-white shadow-sm transition hover:bg-cyan-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-600 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:bg-cyan-200 disabled:text-cyan-800 dark:bg-cyan-600 dark:hover:bg-cyan-500 dark:focus-visible:ring-cyan-400 dark:focus-visible:ring-offset-gray-900 dark:disabled:bg-cyan-950 dark:disabled:text-cyan-400"
              >
                {aiGeneratingDaySchedule
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="rounded-xl bg-green-700 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-green-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-600 focus-visible:ring-offset-2 dark:bg-green-600 dark:hover:bg-green-500 dark:focus-visible:ring-green-400 dark:focus-visible:ring-offset-gray-900"
          >
            Registrer tid
          </button>
      ...
      <div className="flex flex-col items-center justify-center gap-3 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2">
          ...
          <button
            type="button"
            onClick={onToday}
            className="rounded-xl bg-black px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-gray-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 dark:bg-white dark:text-black dark:hover:bg-gray-200 dark:focus-visible:ring-white dark:focus-visible:ring-offset-gray-900"
          >
            I dag
          </button>

          <label className="relative inline-flex h-10 w-10 cursor-pointer items-center justify-center rounded-xl border border-blue-300 bg-blue-50 text-lg text-blue-900 shadow-sm transition hover:bg-blue-100 focus-within:outline-none focus-within:ring-2 focus-within:ring-blue-600 focus-within:ring-offset-2 dark:border-blue-800 dark:bg-blue-950/40 dark:text-blue-100 dark:hover:bg-blue-950 dark:focus-within:ring-blue-400 dark:focus-within:ring-offset-gray-900">
