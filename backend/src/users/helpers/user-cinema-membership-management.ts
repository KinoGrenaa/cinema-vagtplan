...
function resolveNextDefaultCinemaId(
  user: Awaited<
    ReturnType<
      typeof findMembershipTarget
    >
...
export async function findManagedUserCinemaMemberships(
  ...
  return formatManagedMemberships(
    user,
  );
}
...
export async function updateManagedUserCinemaMemberships(
  ...
  await auditLogsService.create({
    ...
    description:
      `Opdaterede biograftilknytninger for ` +
